  ...
  <div class="bg-[#231F25] min-h-screen text-[#F5F5F5]">
    <div class="flex flex-col">
      ...
      <div class="mx-[1rem] pt-[1rem]">
        ...
        <div v-if="!selectedCity" class="text-left text-[#9C9C9C] mt-[1.4rem]">
          Выберите город, чтобы увидеть доступные обменники.
        </div>
      </div>

      <!-- Переключатель и контент -->
      <div v-if="selectedCity" class="mt-[1rem]">
        <!-- ПЕРЕКЛЮЧАТЕЛЬ -->
        <div class="toggle-group mx-[1rem]">
          <button
        ...
        <!-- СПИСОК -->
        <div v-if="mode === 'list'" class="mx-[1rem] flex flex-col gap-[1rem]">
          <adres-info
        ...
        <!-- КАРТА на всю ширину -->
        <div v-if="mode === 'cart'" class="w-full min-h-[400px]">
          <Cart
